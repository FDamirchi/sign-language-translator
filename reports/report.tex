...
\begin{table}[H]
\centering
\caption{خلاصه مراحل \eng{Fine-Tuning} و نتایج}
...
مرحله ۲ & \eng{A, S, T} & \eng{3} & بهبود تشخیص \eng{S} و \eng{T} در \eng{Real-time} \\
مرحله ۳ & همه کلاس‌ها (وزن یکسان) & \eng{3} & تثبیت عملکرد و جلوگیری از \eng{Overfitting} \\
\bottomrule
\end{tabularx}
\end{table}
